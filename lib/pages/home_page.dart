...
class CircleIndicator extends Decoration {
  ...
  BoxPainter createBoxPainter([VoidCallback?onChanged]) {
    ...
    return _CirclePaiter(color: color, radius: radius);
  }

}

class _CirclePaiter extends BoxPainter {
  final Color color;
  double radius;

  _CirclePaiter({required this.color, required this.radius});
  ...
  void paint(
    ...
    final Offset _cicleOffset = Offset(configuration.size!.width / 2-radius/2, configuration.size!.height-radius);
    canvas.drawCircle(offset+_cicleOffset, radius, _paint);
